...
export async function detectPythonExecutable() {
  ...
  spinner.fail('No available Python executable found.')
  throw new Error('No available Python executable found. Please ensure Python is installed and in your PATH.')
}
